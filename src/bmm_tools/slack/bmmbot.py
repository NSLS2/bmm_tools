...
class BMMbot():
    ...
    def __init__(self):
        ...
        self._redis_client = None # redis.Redis(host=profile_configuration.get('services', 'nsls2_redis'))
        self._pass_api = None # profile_configuration.get('services', 'pass_api') + "/{pass_id}/slack-channels"
